...
// NewLarkNotifier is the constructor for the Dingding notifier
func NewLarkNotifier(model *NotificationChannelConfig, t *template.Template) (*LarkNotifier, error) {
...
func (dd *LarkNotifier) Notify(ctx context.Context, as ...*types.Alert) (bool, error) {
	dd.log.Info("Sending lark")
	...
	if err := bus.DispatchCtx(ctx, cmd); err != nil {
		return false, fmt.Errorf("send notification to lark: %w", err)
	}

	return true, nil
}

func (dd *LarkNotifier) SendResolved() bool {
